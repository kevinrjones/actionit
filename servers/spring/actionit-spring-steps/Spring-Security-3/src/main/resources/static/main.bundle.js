...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_todos_newtodo_newtodo_component__ = __webpack_require__("../../../../../src/app/components/todos/newtodo/newtodo.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        entryComponents: [__WEBPACK_IMPORTED_MODULE_9__components_todos_newtodo_newtodo_component__["a" /* NewtodoComponent */], __WEBPACK_IMPORTED_MODULE_12__components_authentication_login_login_component__["a" /* LoginComponent */]],
        providers: [
            {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models___ = __webpack_require__("../../../../../src/app/models/index.ts");
...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.authenticate = function (userName, password) {
        ...
        return this._http.get(this.url, {
            headers: new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["b" /* HttpHeaders */]().set('Authorization', 'Basic ' + btoa(userName + ":" + password))
        })
            .map(function (user) {
    ...
    AuthenticationService.prototype.handleError = function (error) {
        if (error.status == 401) {
            this.user = new __WEBPACK_IMPORTED_MODULE_6__models___["a" /* User */]();
            return __WEBPACK_IMPORTED_MODULE_2_rxjs__["Observable"].of(this.user);
        }
...
AuthenticationService = __decorate([
    ...
    __param(1, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["f" /* Inject */])(__WEBPACK_IMPORTED_MODULE_5__shared_projectConfigDef__["a" /* AppConfig */])),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpClient */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__shared_projectConfig__["ProjectConfig"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__shared_projectConfig__["ProjectConfig"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_7__shared__["b" /* LocalStorageService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__shared__["b" /* LocalStorageService */]) === "function" && _d || Object])
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        }, function (error) { return _this.activeModal.close({ 'Save': false }); });
    };
...
NavigationModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        imports: [__WEBPACK_IMPORTED_MODULE_5__angular_common__["c" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* RouterModule */]],
...
var TodoComponent = (function () {
    ...
    Object.defineProperty(TodoComponent.prototype, "borderColor", {
        get: function () {
            if (this.todo.priority === __WEBPACK_IMPORTED_MODULE_1__todo__["a" /* Priority */].High) {
                return '#ac0000';
            }
            ;
            if (this.todo.priority === __WEBPACK_IMPORTED_MODULE_1__todo__["a" /* Priority */].Medium) {
                return '#f8801c';
            }
            ;
            if (this.todo.priority === __WEBPACK_IMPORTED_MODULE_1__todo__["a" /* Priority */].Low) {
                return '#fcc12b';
            }
            ;
            return '#c0c0c0';
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["r" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__todo__["b" /* ToDo */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__todo__["b" /* ToDo */]) === "function" && _a || Object)
...
var ToDoService = (function () {
    ...
    ToDoService.prototype.getCurrentToDos = function () {
        return this._http.get(this.url)
            .map(function (resp) { return __WEBPACK_IMPORTED_MODULE_6_underscore__["map"](resp, function (item) { return new __WEBPACK_IMPORTED_MODULE_7__todo_todo__["b" /* ToDo */](item); }); })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__storage_service__ = __webpack_require__("../../../../../src/app/shared/storage.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__interceptors_auth_interceptor__ = __webpack_require__("../../../../../src/app/shared/interceptors/auth-interceptor.ts");
...
SharedModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        providers: [__WEBPACK_IMPORTED_MODULE_1__message_service__["a" /* SimpleMessageService */], __WEBPACK_IMPORTED_MODULE_6__storage_service__["a" /* LocalStorageService */],
            {
                provide: __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["e" /* HTTP_INTERCEPTORS */],
                useClass: __WEBPACK_IMPORTED_MODULE_7__interceptors_auth_interceptor__["a" /* AuthInterceptor */],
                multi: true,
            },
            {
                provide: __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["e" /* HTTP_INTERCEPTORS */],
        ...
        imports: [],
        declarations: [],
        exports: [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__angular_common__["c" /* CommonModule */]]
    })
], SharedModule);
