...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_todos_todos_component__ = __webpack_require__("../../../../../src/app/components/todos/todos.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__shared_projectConfigDef__ = __webpack_require__("../../../../../src/app/shared/projectConfigDef.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared__ = __webpack_require__("../../../../../src/app/shared/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_navigation_navigation_module__ = __webpack_require__("../../../../../src/app/components/navigation/navigation.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_authentication_authentication_module__ = __webpack_require__("../../../../../src/app/components/authentication/authentication.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_todos_todos_module__ = __webpack_require__("../../../../../src/app/components/todos/todos.module.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__components_todos_todos_component__["a" /* TodosComponent */],
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__shared__["a" /* SharedModule */],
            __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* HttpModule */],
            __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HttpClientModule */],
            __WEBPACK_IMPORTED_MODULE_13__components_navigation_navigation_module__["a" /* NavigationModule */],
            __WEBPACK_IMPORTED_MODULE_14__components_authentication_authentication_module__["a" /* AuthenticationModule */],
            __WEBPACK_IMPORTED_MODULE_15__components_todos_todos_module__["a" /* TodoModule */]
        ],
        providers: [
            {
                provide: __WEBPACK_IMPORTED_MODULE_11__shared_projectConfigDef__["a" /* AppConfig */],
                useValue: __WEBPACK_IMPORTED_MODULE_11__shared_projectConfigDef__["b" /* PROJECT_CONFIG */]
            }
        ],
...
AuthenticationService = __decorate([
    ...
    __param(1, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["g" /* Inject */])(__WEBPACK_IMPORTED_MODULE_5__shared_projectConfigDef__["a" /* AppConfig */])),
...
module.exports = "<div>\n  <div class=\"modal-header\">\n    <h4 class=\"modal-title\">Register</h4>\n    <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"activeModal.dismiss()\">\n        <span aria-hidden=\"true\">&times;</span>\n    </button>\n  </div>\n  <div class=\"modal-body\">\n    <p>\n      <input class=\"input\" type=\"text\" name=\"email\" [(ngModel)]=\"email\" required placeholder=\"Email\">\n    </p>\n    <p>\n      <input class=\"input\" type=\"text\" name=\"firstName\" [(ngModel)]=\"firstName\" required placeholder=\"First Name\">\n    </p>\n    <p>\n      <input class=\"input\" type=\"text\" name=\"LastName\" [(ngModel)]=\"lastName\" required placeholder=\"Last Name\">\n    </p>\n    <p>\n      <input class=\"input\" type=\"password\" name=\"password\" [(ngModel)]=\"password\" required placeholder=\"Password\">\n    </p>\n    <p>\n      <input class=\"input\" type=\"password\" name=\"repeatPassword\" [(ngModel)]=\"repeatPassword\" required placeholder=\"Repeat Password\">\n    </p>\n  </div>\n  <div class=\"modal-footer\">\n    <button type=\"button\" class=\"btn btn-primary\" (click)=\"register()\" (keyup.enter)=\"login()\" [disabled]=\"isWaiting\">Register</button>\n    <button type=\"button\" class=\"btn btn-secondary\" (click)=\"activeModal.close({'Save': false})\" [disabled]=\"isWaiting\">Cancel</button>\n  </div>\n  <div [hidden]=\"!isError\" class=\"alert alert-danger\">\n    {{message}}\n  </div>\n</div>\n"
...
var RegisterComponent = (function () {
    function RegisterComponent(activeModal, authenticationService) {
        this.activeModal = activeModal;
        this.authenticationService = authenticationService;
    ...
    RegisterComponent.prototype.register = function () {
        ...
        this.isWaiting = true;
        this.authenticationService
            .register(this.email, this.firstName, this.lastName, this.password, this.repeatPassword)
            .subscribe(function (result) {
            _this.activeModal.close({ 'Save': true });
            _this.isWaiting = false;
        }, function (error) {
...
NavigationModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        imports: [__WEBPACK_IMPORTED_MODULE_5__angular_common__["a" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* RouterModule */]],
...
ToDoService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["e" /* Injectable */])(),
    __param(1, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["g" /* Inject */])(__WEBPACK_IMPORTED_MODULE_8__shared_projectConfigDef__["a" /* AppConfig */])),
...
ProjectService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["e" /* Injectable */])(),
    __param(1, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["g" /* Inject */])(__WEBPACK_IMPORTED_MODULE_8__projectConfigDef__["a" /* AppConfig */])),
...
SharedModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        imports: [],
        declarations: [],
        exports: [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__angular_common__["a" /* CommonModule */]]
    })
], SharedModule);
